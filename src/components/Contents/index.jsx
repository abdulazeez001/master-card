...
import {StyledFirstContent,
       StyledSecondContent, 
       StyledThirdContent} from "./styleContent"
...
const Content = () =>{
    return(
        ...
        <StyledFirstContent>
            <div className='first-content'>
                ...
                <div>
                    ...
                    <p className='grey'>Choose your method of payment.</p>
                    <img src={Master} alt="" className='master-card'/>
                </div>
                ...
                <div className='forms'>
                    ...
                    <div className='card-types'>
                        ...
                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="cc-discover" class="svg-inline--fa fa-cc-discover fa-w-18" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                    ...
                    <div className='card-detail-container'>
                        ...
                        <div className='card-detail'>
                            ...
                            <input type="text" id='credit-card' placeholder="432 5433 9382 1030" />
                        </div>
                        <div className='card-detail'>
                        ...
                        <div className='card-detail'>
                            ...
                            <input type="text" id='sec-code' placeholder="420" />
                        </div>
                        <div className='card-detail'>
                            <label htmlFor="postal-code">Postal Code</label>
                            <input type="text" id='postal-code' placeholder="1011" />
                        </div>
                    ...
                    <div className='radio'>
                        <div>
                            ...
                            <label htmlFor="radio">Use this card for next time purchase</label>
                        </div>
       ...
       <StyledSecondContent>
           ...
           <div>
               <p>Promotional Code: <span>Z4KXLM94</span></p>
               <p>₦119.64</p>
           </div>
       </StyledSecondContent>
